...
<link rel="stylesheet" media="all" href="/assets/application-99c3f18b915ef3e3bc4b1a1e24f528f1.css" />
<link rel="stylesheet" media="print" href="/assets/print-2cb1262fb60ceb73f2fe76fd1a61dccf.css" />
<script src="/assets/application-e38d2d3c402c8ad188290331e50045e5.js"></script>
<meta name="csrf-param" content="authenticity_token" />
<meta name="csrf-token" content="VMgAlJs6qRPx8ST36Q1klTtsUoi7Cn7fAyHxKg1h8t476SrkMEAx4zsX7+hqvM5LbSLVfXLWZuhQLcAh4Y6SVg==" />
<script>
//<![CDATA[
window.gon={};gon.api_version="v3";gon.default_avatar_url="https://git.wemomo.com/assets/no_avatar-0801eb7ed213327da2a534095a75b248.png";gon.default_issues_tracker="gitlab";gon.max_file_size=10;gon.relative_url_root="";gon.user_color_scheme="white";
//]]>
</script>
...
<form id="new_ldap_user" action="/users/auth/ldapmain/callback" accept-charset="UTF-8" method="post"><input name="utf8" type="hidden" value="&#x2713;" /><input type="hidden" name="authenticity_token" value="Ch2YWlo4IRaegXvQZ7rhBt2M3atJdfcHxpHxyPc8rOdlPLIq8UK55lRnsM/kC0vYi8JaXoCp7zCVncDDG9PMbw==" />
<input type="text" name="username" id="username" class="form-control top" placeholder="LDAP Login" autofocus="autofocus" />
<input type="password" name="password" id="password" class="form-control bottom" placeholder="Password" />
...
<button name="button" type="submit" class="btn-save btn">Sign in</button>
</form>


</div>
<div class='tab-pane' id='tab-signin'>
<form class="new_user" id="new_user" action="/users/sign_in" accept-charset="UTF-8" method="post"><input name="utf8" type="hidden" value="&#x2713;" /><input type="hidden" name="authenticity_token" value="z9to1fCX2dMPwcM8Pk7dD/4Tvoo9xkLqNXEJ69AEhTqg+kKlW+1BI8UnCCO9/3fRqF05f/QaWt1mfTjgPOvlsg==" /><input class="form-control top" placeholder="Username or Email" autofocus="autofocus" autocapitalize="off" autocorrect="off" type="text" name="user[login]" id="user_login" />
