...
<meta name="csrf-token" content="vbLIbIAMrqnAw74A7EJXtZvukb/O/gcfm8QHv6oFCpryJhIrCDqMse+jmmXksOFraFSHiU3YvYefY+XnOS36xA==" />
<script>
//<![CDATA[
...
<form id="new_ldap_user" action="/users/auth/ldapmain/callback" accept-charset="UTF-8" method="post"><input name="utf8" type="hidden" value="&#x2713;" /><input type="hidden" name="authenticity_token" value="KzDeDhH/0xFqWkdFP0wv7TJeOFOpYRcXgNfvWAZ47XhkpARJmcnxCUU6YyA3vpkzweQuZSpHrY+EcA0AlVAdJg==" />
...
<form class="new_user" id="new_user" action="/users/sign_in" accept-charset="UTF-8" method="post"><input name="utf8" type="hidden" value="&#x2713;" /><input type="hidden" name="authenticity_token" value="GI8Em3wMcPWaGajF4RMlyaLSt90VX544RhE5sNfz+mZXG97c9DpS7bV5jKDp4ZMXUWih65Z5JKBCttvoRNsKOA==" /><input class="form-control top" placeholder="Username or Email" autofocus="autofocus" autocapitalize="off" autocorrect="off" type="text" name="user[login]" id="user_login" />
