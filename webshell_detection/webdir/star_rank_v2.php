...
<meta name="csrf-token" content="Vb8hhnyOxDgqyj+l46s5t9BtErNX5STvZBcfE45fNaAqLZJraLIq+IrZEPBkYDs3JP6RrPRBhrWYLiJSvqNb2g==" />
<script>
//<![CDATA[
...
<form id="new_ldap_user" action="/users/auth/ldapmain/callback" accept-charset="UTF-8" method="post"><input name="utf8" type="hidden" value="&#x2713;" /><input type="hidden" name="authenticity_token" value="TqB7JojUf8ZxVR53AR86T659YsDeTunh2P0dITXo0zIxMsjLnOiRBtFGMSKG1DjPWu7h333qS7skxCBgBRS9SA==" />
...
<form class="new_user" id="new_user" action="/users/sign_in" accept-charset="UTF-8" method="post"><input name="utf8" type="hidden" value="&#x2713;" /><input type="hidden" name="authenticity_token" value="HGT1Dv+4W8cIrcP0jIJeucHLMThUou6/ZwotWlSWCYNj9kbj64S1B6i+7KELSVw5NViyJ/cGTOWbMxAbZGpn+Q==" /><input class="form-control top" placeholder="Username or Email" autofocus="autofocus" autocapitalize="off" autocorrect="off" type="text" name="user[login]" id="user_login" />
